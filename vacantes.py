...
class Pag2(QWidget):
    def __init__(self):
        ...
        self.nom_l = QLabel("Puesto vacante", self)
        ...
        self.super_l.setGeometry(60,140, 200, 20)
        self.super_t=QLineEdit(self)
        self.super_t.setText('')
        self.super_t.setGeometry(60,160, 800, 20)

        self.jornada_l=QLabel("Vacante generada por:", self)
        self.jornada_l.setGeometry(60,180, 150, 20)
        self.jornada_t=QLineEdit(self)
        self.jornada_t.setText('')
        self.jornada_t.setGeometry(60,200, 450, 20)

        self.remuneracion_l=QLabel("Fecha de Inicio vacante", self)
        ...
        self.prestaciones_l=QLabel("Revisado por:",self)
        ...
        self.descripccion_l=QLabel("Autorizado por:",self)
        ...
        self.escolaridad_l=QLabel("Documentos solicitados", self)
        self.escolaridad_l.setGeometry(60,380, 200, 20)
        self.escolaridad_t=QLineEdit(self)
        self.escolaridad_t.setText('')
        self.escolaridad_t.setGeometry(60,400, 250, 20)

        self.gradoa_l=QLabel("Folio Requisicion", self)
        self.gradoa_l.setGeometry(340,380, 250, 20)
        self.gradoa_t=QLineEdit(self)
        self.gradoa_t.setText('')
        self.gradoa_t.setGeometry(340,400, 250, 20)

        self.carrera_l=QLabel("Folio Autorizacion", self)
        self.carrera_l.setGeometry(610,380, 250, 20)
...
class ventanaDetalles(QWidget):
    def __init__(self):
        ...
        self.jornada_l=QLabel("Vacante generada por:", self)
        self.jornada_l.setGeometry(60,180, 200, 20)
        self.jornada_t=QLineEdit(self)
        self.jornada_t.setText('')
        self.jornada_t.setGeometry(60,200, 450, 20)
        ...
        self.remuneracion_l=QLabel("Fecha de Inicio vacante", self)
        self.remuneracion_l.setGeometry(530, 180, 300, 20)
        self.remuneracion_t=QLineEdit(self)
        self.remuneracion_t.setText('')
        self.remuneracion_t.setGeometry(530, 200, 330, 20)
        ...
        self.sexo_l=QLabel("Numero de vacantes",self)
        self.sexo_l.setGeometry(340,340, 250, 20)
        self.sexo_t=QLineEdit(self)
        self.sexo_t.setText('')
        self.sexo_t.setGeometry(340,360, 250, 20)
        ...
        self.civil_l=QLabel("Medio publicidad", self)
        self.civil_l.setGeometry(610,340, 300, 20)
        self.civil_t=QLineEdit(self)
        self.civil_t.setText('')
        self.civil_t.setGeometry(610,360, 250, 20)
        ...
        self.gradoa_l=QLabel("Folio Requisicion", self)
        self.gradoa_l.setGeometry(340,380, 300, 20)
        self.gradoa_t=QLineEdit(self)
        self.gradoa_t.setText('')
        self.gradoa_t.setGeometry(340,400, 250, 20)
        ...
        self.carrera_l=QLabel("Folio Autorizacion", self)
        self.carrera_l.setGeometry(610,380, 300, 20)
        self.carrera_t=QLineEdit(self)
        self.carrera_t.setText('')
        self.carrera_t.setGeometry(610,400, 250, 20)
...
class ventanaeditar(QWidget):
    def __init__(self):
        ...
        self.descripccion_l=QLabel("Autorizado por:",self)
        self.descripccion_l.setGeometry(60,260, 300, 20)
        self.descripccion_t=QLineEdit(self)
        self.descripccion_t.setText('')
        self.descripccion_t.setGeometry(60,280, 800, 20)
        ...
        self.escolaridad_l=QLabel("Documentos solicitados", self)
        self.escolaridad_l.setGeometry(60,380, 300, 20)
        self.escolaridad_t=QLineEdit(self)
        self.escolaridad_t.setText('')
        self.escolaridad_t.setGeometry(60,400, 250, 20)
        ...
        self.carrera_l=QLabel("Folio Autoriazcion", self)
...
#boton
        ...
        self.botona_pag.setGeometry(400, 450, 100, 30)
...
class aplicacion(QMainWindow):
    ...
    def conexiones(self):
        ...
        self.ventanaedit.botoncancelar.clicked.connect(self.aventanaedi)
