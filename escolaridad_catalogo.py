...
class Vescolaridad(QWidget):
    def __init__(self):
        super(Vescolaridad, self).__init__()
    ...
    def generartabla(self):
        ...
        self.agregar = QPushButton('Agregar Escolaridad')
    ...
    def nuevosdatos(self):
        ...
        if result == QDialog.DialogCode.Accepted:
            nombre = ventanita.escolaridad.text()
...
class emergente(QDialog):
    def __init__(self):
        ...
        self.escolaridadP=QLabel('Ingrese la ecolaridad:',self)
        self.escolaridadP.setGeometry(10,25,160,15)
        self.escolaridad=QLineEdit(self)
        ...
        layout = QVBoxLayout()
        layout.addWidget(self.escolaridad)
        layout.addWidget(self.Id)
        layout.addWidget(verifica)
        self.setLayout(layout)

    def campos(self):
        escolaridad_texto = self.escolaridad.text().strip()
        id_texto = self.Id.text().strip()

        if not escolaridad_texto or not id_texto:
            stilo = """QDialog {background-color: #072d44}"""
            self.setStyleSheet(stilo)
...
class emergente2(QDialog):
    def __init__(self):
        ...
        self.close_button.setGeometry(220, 0, 30, 30)
        self.setFixedSize(250, 230) 
        self.escolaridadP=QLabel('Ingrese la nueva esolaridad:',self)
        self.escolaridadP.setGeometry(10,15,160,15)
        self.escolaridad=QLineEdit(self)
        self.Idl = QLabel('Ingrese el nuevo Id:', self)
        self.Idl.setGeometry(10,62,160,15)
        self.Id = QLineEdit(self)  
        self.Idl2=QLabel('Ingrese el id de la esolaridad a cambiar:', self)
