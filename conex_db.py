...
class database:
    ...
    def verify_schema(self):
        try:
            sql = "CREATE DATABASE IF NOT EXISTS db_poo"
            self.cursor.execute(sql)
            self.comit()
            print("Base de datos creada exitosamente")
        except Exception as ex:
            print("La base de datos ya existe o ha ocurrido algun error. Más detalles en el sig mensaje")
            print(ex)
    ...
    def create_tables(self):
        try:
            ...
            print("Error al crear tablas. Más detalles en el siguiente mensaje")
            print(ex)
